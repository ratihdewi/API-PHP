<?php
	if(!empty($_GET['m']) and $_GET['m']=='dosen'  and !empty($_GET['op']) and $_GET['op']=='import'){		
	?>
	<div id="smallRight">
 ...
 /*Query SQL*/
		$insert = "INSERT into dosen(id_dosen,id_level,username,password,nama,email)values('$no','$level','$username','$password','$nama','$email')";
