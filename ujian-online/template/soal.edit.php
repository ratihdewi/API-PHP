<?php
	if(!empty($_GET['m']) and $_GET['m']=='soal'  and !empty($_GET['op']) and $_GET['op']=='edit' and !empty($_GET['id']) ){		
	?>
...
<table id="box-table-a" summary="Meeting Results">
   <thead>
    		    ...
    		    echo "No information available<br />\n";
	    			...
	    			{	  
	    				case $pk:
	    					...
	    					break;
						case "soal":
	    					$inp = "<textarea required name='".$meta->name."' cols='50' rows='5' id='".$meta->name."'>".$f[$meta->name]."</textarea>";
	    					break;
						case "jawaban":
	    					$inp = "<textarea required name='".$meta->name."' cols='50' rows='5' id='".$meta->name."'>".$f[$meta->name]."</textarea>";
	    					break;	
						case "bobot":
	    					...
	    					break;    				
	    				default:	
			    			$inp = "<input required type='text' readonly name='".$meta->name."' id='".$meta->name."' value='".$f[$meta->name]."'>";	    					
	    			}
    ...
    <tbody>
    	...
    	<input type='submit' class='btnLogin' name='simpan' value='Simpan'>
    	</td>
    </body>
</table>
</form>
