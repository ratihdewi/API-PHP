<?php
	if(!empty($_GET['m']) and $_GET['m']=='mahasiswa'  and !empty($_GET['op']) and $_GET['op']=='import'){		
	?>
	<div id="smallRight">
 ...
 /*Query SQL*/
		$insert = "INSERT into mahasiswa(id_mahasiswa,id_level,username,password,nama,email)values('$no','$level','$username','$password','$nama','$email')";
